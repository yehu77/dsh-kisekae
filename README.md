...
The first working skin is “DeepSeek Blue Whale-chan,” an unofficial community theme built around cool ocean daylight and a deep-sea night palette. Installing the package immediately overlays 23 semantic color tokens, two role-scoped conversation text-shadow tokens, and one shared conversation font-weight token while preserving the official Harness Light, Dark, and System preferences. The settings page also includes a 42-image gallery, a phase-aware main conversation background, the “Blue Whale glass sidebar · Rain veil,” and themed composer, New Session, and Settings surfaces.
