...
- Mount the sidebar backdrop, New Session decoration, wave-chat glyph, Settings trigger decoration, and corner artwork only while Blue Whale-chan is the visible draft. Official preview removes the group, and Cancel restores the saved skin's group without clearing its preferences.
